export const serviceCategories = [
  ...
  },
  {
    ...
    seoTitle: "Body Contouring & CoolTone in Englewood, CO | Artful Aesthetic Medicine",
    seoDescription:
      "Non-invasive CoolTone body contouring and muscle toning in Englewood, CO. Sculpt and strengthen at Artful Aesthetic Medicine.",
  },
  {
    slug: "microblading",
    ...
    faq: [
      {
        ...
        a: "No. CoolSculpting reduces fat, while CoolTone builds and tones muscle. They can be used together.",
      },
      {
        q: "How many sessions are needed?",
        a: "A series of about 4 sessions is typical for visible results.",
      },
      {
        q: "When will I see results?",
        a: "Improvement builds over the weeks following the treatment series as muscle fibers respond and strengthen.",
      },
      {
        q: "Who's a good candidate?",
        a: "Those close to their goal weight looking to build definition, rather than those seeking fat loss.",
      },
    ],
  },
  {
