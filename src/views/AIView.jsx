...
export function AIView({ apiKey, mode = "ai", onModeChange, prefill, context, onPrefillConsumed }) {
  ...
  if (mode === "expert") {
    return (
      <div style={{ display: "grid", gap: 18 }}>
        <AnalysisTierToggle mode={mode} onChange={onModeChange} />
        <ExpertReviewPanel context={context} />
      </div>
    );
  }
  ...
  return (
    <div style={{ display: "grid", gap: 18 }}>
      ...
      <div className="responsive-grid-chat">
        <Card style={{ display: "flex", flexDirection: "column", height: "100%" }}>
          ...
          >
            ...
            {messages.length > 1 && !loading && (
              <ExpertUpsellCard onBookExpert={() => onModeChange?.("expert")} />
            )}
            <div ref={bottomRef} />
          </div>
          <Divider />
